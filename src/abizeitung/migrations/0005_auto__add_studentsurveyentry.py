...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'abizeitung_studentsurveyentry', (
            ...
            ('student', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['abizeitung.Student'], null=True)),
            ('survey', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['abizeitung.StudentSurvey'], null=True)),
        ))
    ...
    models = {
        ...
        u'abizeitung.studentsurveyentry': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'student': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['abizeitung.Student']", 'null': 'True'}),
