...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TeacherSurvey.question'
        db.add_column(u'abizeitung_teachersurvey', 'question',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)

        # Adding field 'StudentSurvey.question'
        db.add_column(u'abizeitung_studentsurvey', 'question',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TeacherSurvey.question'
        db.delete_column(u'abizeitung_teachersurvey', 'question')

        # Deleting field 'StudentSurvey.question'
        db.delete_column(u'abizeitung_studentsurvey', 'question')
