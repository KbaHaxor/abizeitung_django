...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Student', fields ['user']
        db.delete_unique(u'abizeitung_student', ['user_id'])

        # Adding field 'Student.lebensmotto'
        db.add_column(u'abizeitung_student', 'lebensmotto',
        ...
        db.alter_column(u'abizeitung_student', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))

    def backwards(self, orm):
        # Deleting field 'Student.lebensmotto'
        db.delete_column(u'abizeitung_student', 'lebensmotto')
        ...
        # Changing field 'Student.user'
        db.alter_column(u'abizeitung_student', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True))
        # Adding unique constraint on 'Student', fields ['user']
        db.create_unique(u'abizeitung_student', ['user_id'])
