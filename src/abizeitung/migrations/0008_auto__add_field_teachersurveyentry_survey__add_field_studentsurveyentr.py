...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TeacherSurveyEntry.survey'
        db.add_column(u'abizeitung_teachersurveyentry', 'survey',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['abizeitung.TeacherSurvey'], null=True),
                      keep_default=False)

        # Removing M2M table for field entries on 'StudentSurvey'
        db.delete_table(db.shorten_name(u'abizeitung_studentsurvey_entries'))

        # Adding field 'StudentSurveyEntry.survey'
        db.add_column(u'abizeitung_studentsurveyentry', 'survey',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['abizeitung.StudentSurvey'], null=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Deleting field 'TeacherSurveyEntry.survey'
        db.delete_column(u'abizeitung_teachersurveyentry', 'survey_id')
        ...
        # Deleting field 'StudentSurveyEntry.survey'
        db.delete_column(u'abizeitung_studentsurveyentry', 'survey_id')
