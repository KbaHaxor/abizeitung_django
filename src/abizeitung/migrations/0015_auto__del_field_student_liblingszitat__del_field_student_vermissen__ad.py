...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Student.lieblingszitat'
        db.add_column(u'abizeitung_student', 'lieblingszitat',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'Student.wen_vermissen'
        db.add_column(u'abizeitung_student', 'wen_vermissen',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Student.lieblingszitat'
        db.delete_column(u'abizeitung_student', 'lieblingszitat')

        # Deleting field 'Student.wen_vermissen'
        db.delete_column(u'abizeitung_student', 'wen_vermissen')
    ...
    models = {
        u'abizeitung.student': {
            ...
            'lieblingszitat': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '255', 'blank': 'True'}),
            ...
            'wen_vermissen': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '255', 'blank': 'True'}),
