...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'abizeitung_student', 'tutor',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['abizeitung.Teacher'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Student.tutor'
        db.delete_column(u'abizeitung_student', 'tutor_id')
