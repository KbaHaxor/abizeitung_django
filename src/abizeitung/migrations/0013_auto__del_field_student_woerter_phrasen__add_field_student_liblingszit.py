...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Student.liblingszitat'
        db.add_column(u'abizeitung_student', 'liblingszitat',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'Student.biographie'
        db.add_column(u'abizeitung_student', 'biographie',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'Student.hobbies'
        db.add_column(u'abizeitung_student', 'hobbies',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'Student.lieblingsserie'
        db.add_column(u'abizeitung_student', 'lieblingsserie',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'Student.lieblingsmusik'
        db.add_column(u'abizeitung_student', 'lieblingsmusik',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'Student.beschaeftigung_unterricht'
        db.add_column(u'abizeitung_student', 'beschaeftigung_unterricht',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'Student.vermissen'
        db.add_column(u'abizeitung_student', 'vermissen',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'Student.ohne_wen_abi_nicht'
        db.add_column(u'abizeitung_student', 'ohne_wen_abi_nicht',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'Student.unvergessliche_momente'
        db.add_column(u'abizeitung_student', 'unvergessliche_momente',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'Student.lieblingsprodukt_sky'
        db.add_column(u'abizeitung_student', 'lieblingsprodukt_sky',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'Student.schlusswort'
        db.add_column(u'abizeitung_student', 'schlusswort',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Student.liblingszitat'
        db.delete_column(u'abizeitung_student', 'liblingszitat')

        # Deleting field 'Student.biographie'
        db.delete_column(u'abizeitung_student', 'biographie')

        # Deleting field 'Student.hobbies'
        db.delete_column(u'abizeitung_student', 'hobbies')

        # Deleting field 'Student.lieblingsserie'
        db.delete_column(u'abizeitung_student', 'lieblingsserie')

        # Deleting field 'Student.lieblingsmusik'
        db.delete_column(u'abizeitung_student', 'lieblingsmusik')

        # Deleting field 'Student.beschaeftigung_unterricht'
        db.delete_column(u'abizeitung_student', 'beschaeftigung_unterricht')

        # Deleting field 'Student.vermissen'
        db.delete_column(u'abizeitung_student', 'vermissen')

        # Deleting field 'Student.ohne_wen_abi_nicht'
        db.delete_column(u'abizeitung_student', 'ohne_wen_abi_nicht')

        # Deleting field 'Student.unvergessliche_momente'
        db.delete_column(u'abizeitung_student', 'unvergessliche_momente')

        # Deleting field 'Student.lieblingsprodukt_sky'
        db.delete_column(u'abizeitung_student', 'lieblingsprodukt_sky')

        # Deleting field 'Student.schlusswort'
        db.delete_column(u'abizeitung_student', 'schlusswort')
